...
- KH-L-0002 [L4,AV6,CFG][VYRE][L] Replace every hardcoded `0.6.1` in vyre release tooling with a single version source (workspace.package.version). Proof: `grep -rn '0\.6\.1' libs/.../vyre` returns only the version field; dry-run cuts `0.6.2`.
