...
//!   * verification.md "344 of the 902 detectors do (about 38%)"
//!
//! A prior README said 341 and verification.md said "About 60%"; both had drifted
//! from the corpus (the real count is 344 of 902 = 38%). A doc number nobody pins
...
fn verify_block_count_is_pinned_and_every_block_has_a_url() {
    ...
    assert_eq!(
        total, 902,
        "shipped detector corpus is 902 TOMLs (the README/docs cited total); got {total}. \
