//! E2E R5-T-CLI: scan git history clean repo exits zero.rs.
...
#[test]
fn scan_git_history_clean_repo_exits_zero() {
    ...
    let output = Command::new(binary())
        .args(["scan", "--no-daemon", "--git-history", "--format", "json", "--max-commits", "5"])
