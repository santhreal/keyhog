//! E2E R5-T-CLI: scan git staged severity critical filter.rs.
...
#[test]
fn scan_git_staged_severity_critical_filter() {
    ...
    let output = Command::new(binary())
        .args(["scan", "--no-daemon", "--git-staged", "--severity", "critical", "--format", "json", "--no-suppress-test-fixtures"])
