...
pub const CANONICAL_SCAN_ARGS: &str = "scan --fast --git-staged --backend cpu";
...
pub fn find_hooks_dir_for_repo(repo_root: &std::path::Path) -> Result<PathBuf> {
