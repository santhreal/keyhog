...
impl AutorouteDecision {
    ...
    pub(super) fn merge_calibration_point(
        ...
        let expected_one_shot = reconciled_one_shot.unwrap_or(expected_one_shot); // LAW10: guarded above by is_none check
        let expected_daemon = reconciled_daemon.unwrap_or(expected_daemon); // LAW10: guarded above by is_none check
