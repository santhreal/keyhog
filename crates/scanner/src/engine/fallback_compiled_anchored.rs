//! Shared-anchor localized fallback scan, extracted from `fallback_compiled.rs`
//! (Law 5). `scan_fallback_with_anchors` (+ its anchor-only scratch helper
//! `with_active_fallback_scratch`) collapses the per-pattern whole-chunk walks
...
//! `use super::*` / `use super::fallback::*` globs the parent uses.
use super::fallback::*;
use super::*;
...
impl CompiledScanner {
    ...
    pub(crate) fn scan_fallback_with_anchors(
        &self,
