...
/// (MD5/SHA1/SHA256/SHA512). UUID-v4 is handled separately by
/// [`is_uuid_v4_shape`] because the named-detector path gates the two
/// arms independently via `bypass_shape_gates`.
///
