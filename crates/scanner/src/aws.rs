...
//!
//! The implementation is the fleet-canonical [`keyhog_core::finding_metadata`] — it
...
//!
//! Algorithm + canary-list provenance: see [`keyhog_core::finding_metadata`] and
...
// No tests here on purpose: this module only re-exports the core AWS metadata API, and
