...
impl CompiledDetectorMlFeatures {
    pub(crate) fn compile(detector: &keyhog_core::DetectorSpec) -> Self {
        ...
        Self {
            ...
            entropy_high: detector.entropy_high.unwrap_or(HIGH_ENTROPY_THRESHOLD), // LAW10: canonical default for model-neutral training when a detector owns no entropy admission
