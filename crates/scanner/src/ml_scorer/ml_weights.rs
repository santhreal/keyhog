...
//!
//! Architecture: gate Linear(43,6) → Softmax plus 6 experts of
//! Linear(43,32) → ReLU → Linear(32,16) → ReLU → Linear(16,1)
//!
//! Generated by: `python3 ml/train_classifier.py --features 43 --write`
//! Serialized as little-endian `f32` values so parsing is deterministic across
//! host architectures. INPUT_DIM (43) is owned by `model_arch.rs`; the feature
