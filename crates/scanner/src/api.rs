...
pub use crate::engine::{
    ...
    set_gpu_batch_input_limit, set_perf_trace_enabled, set_profile_enabled, BackendRecoveryReceipt,
    CoalescedScanOutcome, CompiledScanner, GpuLiteralArtifact, GpuLiteralArtifacts,
    Phase1AdmissionPlan, Phase1AdmissionSummary, RecoveredInputRange,
};
