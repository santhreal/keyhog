//! Feasibility measurement for the GPU fallback port (`docs/GPU_DETECTION_REWRITE.md`
...
//!
//! Run: cargo test -p keyhog-scanner --features gpu --test fallback_shard_size -- --ignored --nocapture
