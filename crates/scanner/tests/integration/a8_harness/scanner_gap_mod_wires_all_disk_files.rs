...
fn no_new_unreachable_gap_rs_files() {
    ...
    let allowed_unreachable: BTreeSet<&'static str> = [
        ...
        "tests/gap/detector_contract_coverage_100pct.rs",
        ...
        "tests/gap/findings_registry_integrity.rs",
        "tests/gap/inline_gate.rs",
        "tests/gap/multiline_reassembly.rs",
        "tests/gap/nightly_exports_all_strict_env_vars.rs",
        "tests/gap/nightly_matrix_has_fourteen_runner_binaries.rs",
        "tests/gap/no_suppress_test_fixtures_clears_generic_fallback_haircut.rs",
        "tests/gap/orphan_github_pat_contract.rs",
        ...
        "tests/gap/scanner_src_files_exceed_standard_500_loc.rs",
