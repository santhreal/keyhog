...
//! DUMMY / FAKE / MOCK / SAMPLE / CHANGEME). Without this, a `ghp_EXAMPLE_...` /
...
fn placeholder_words_skip_the_floor() {
    ...
    // Other shared placeholder words: DUMMY, FAKE, MOCK, SAMPLE, CHANGEME.
    assert_eq!(
        known_prefix_confidence_floor("ghp_DUMMYabcdef0123456"),
        None
    );
    assert_eq!(known_prefix_confidence_floor("ghp_fakeabcdef0123456"), None);
    assert_eq!(known_prefix_confidence_floor("ghp_MOCKabcdef0123456"), None);
    assert_eq!(
