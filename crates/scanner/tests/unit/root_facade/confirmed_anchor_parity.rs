...
#[test]
fn confirmed_anchor_uses_compact_nfa_for_reused_shared_catalog() {
    ...
    assert_eq!(
        ...
        Some(aho_corasick::AhoCorasickKind::ContiguousNFA),
        "confirmed shared-anchor collection must retain the compact automaton"
    );
}
