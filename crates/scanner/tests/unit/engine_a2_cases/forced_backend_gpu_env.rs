...
fn forced_backend_gpu_env() {
    ...
    assert_eq!(parse_backend_str("gpu-mega-scan"), Some(ScanBackend::MegaScan));
    assert_eq!(parse_backend_str("regex-nfa"), Some(ScanBackend::MegaScan));
    assert_eq!(parse_backend_str("rule-pipeline"), Some(ScanBackend::MegaScan));
    ...
    assert_eq!(parse_backend_str("cpu-fallback"), Some(ScanBackend::CpuFallback));
