...
#[test]
fn adv30_epa_normal_bare_must_stay_silent() {
    assert_detector_silent("epa-api-key", "epa_key = \"abcde12345abcde12345\"");
}
...
#[test]
fn adv30_epa_evade_zwsp_bare_must_stay_silent() {
    assert_detector_silent("epa-api-key", "epa\u{200B}_key = \"abcde12345abcde12345\"");
}

#[test]
fn adv30_epa_evade_soft_hyphen_bare_must_stay_silent() {
    assert_detector_silent("epa-api-key", "epa_key = \"abcde12345abcde\u{00AD}12345\"");
}

#[test]
fn adv30_epa_evade_homoglyph_bare_must_stay_silent() {
    assert_detector_silent("epa-api-key", "\u{0435}pa_key = \"abcde12345abcde12345\"");
}
