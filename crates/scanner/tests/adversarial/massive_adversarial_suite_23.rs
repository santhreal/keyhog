...
#[test]
fn adv23_definedfi_normal_must_fire() {
...
#[test]
fn adv23_definedfi_evade_zwsp_must_fire() {
    assert_detector_fires(
        "definedfi-api-key",
...
#[test]
fn adv23_definedfi_evade_soft_hyphen_must_fire() {
    assert_detector_fires(
        "definedfi-api-key",
...
#[test]
fn adv23_definedfi_evade_homoglyph_must_fire() {
    assert_detector_fires(
        "definedfi-api-key",
...
#[test]
fn adv23_descope_normal_must_fire() {
    assert_detector_fires(
        "descope-api-key",
...
#[test]
fn adv23_descope_evade_zwsp_must_fire() {
    assert_detector_fires(
        "descope-api-key",
...
#[test]
fn adv23_descope_evade_soft_hyphen_must_fire() {
    assert_detector_fires(
        "descope-api-key",
...
#[test]
fn adv23_descope_evade_homoglyph_must_fire() {
    assert_detector_fires(
        "descope-api-key",
...
#[test]
fn adv23_devcycle_normal_must_fire() {
    assert_detector_fires(
...
#[test]
fn adv23_devcycle_evade_zwsp_must_fire() {
    assert_detector_fires(
        "devcycle-api-credentials",
...
#[test]
fn adv23_devcycle_evade_soft_hyphen_must_fire() {
    assert_detector_fires(
        "devcycle-api-credentials",
...
#[test]
fn adv23_devcycle_evade_homoglyph_must_fire() {
    assert_detector_fires(
        "devcycle-api-credentials",
