...
#[test]
fn adv6_algolia_normal_must_fire() {
    assert_detector_fires("algolia-api-key", "algolia-api-12345", "algolia-api-12345");
}
#[test]
...
#[test]
fn adv6_amplitude_normal_must_fire() {
    assert_detector_fires("amplitude-api-key", "amplitude-12345", "amplitude-12345");
}
#[test]
