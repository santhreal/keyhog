...
//!   * `crates/scanner/src/multiline/fragment_cache.rs` (`FragmentCache`,
...
//! The public surface used is `keyhog_scanner::multiline::*` and
//! `keyhog_scanner::fragment_cache::*`.

use keyhog_scanner::fragment_cache::{FragmentCache, ReassembledCandidate, SecretFragment};
use keyhog_scanner::multiline::{
