...
fn canonical_non_secret_shapes_classified() {
    ...
    assert!(is_canonical_non_secret_shape("sha512-abcDEF0123+/=")); // npm SRI
    assert!(is_canonical_non_secret_shape(
...
// ── DUMMY / FAKE / MOCK / SAMPLE / TODO / FIXME placeholder words ────

#[test]
fn universal_placeholder_words_suppressed() {
    // check_markers PLACEHOLDER_WORDS = DUMMY, PLACEHOLDER, FAKE, MOCK, SAMPLE
