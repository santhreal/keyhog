...
//!
//! Run:
//!   KEYHOG_PROFILE_CONFIRMED=1 cargo test --profile release-fast -p keyhog-scanner \
...
#[test]
#[ignore = "measurement; set KEYHOG_PROFILE_CONFIRMED=1 and run with --ignored --nocapture"]
