...
//!        --test fallback_prefilter_hs_vs_regexset -- --ignored --nocapture
#![cfg(feature = "simd")]
...
use hyperscan::{Block as BlockMode, BlockDatabase, Builder, Matching, Pattern, PatternFlags, Patterns};
...
fn hs_vs_regexset_throughput_and_parity() {
    ...
    eprintln!("corpus: {} files, {:.2} MiB", files.len(), total_bytes as f64 / 1048576.0);
