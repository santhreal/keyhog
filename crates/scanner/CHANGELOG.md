...
- Store SIMD pattern mappings, confirmed-suffix rows, and structural detector partitions as flat `u32` offset tables instead of retaining one heap vector per row.
