...
- Memoize empty decode-through outcomes by unique-line vocabulary so overlapping windows of repetitive multi-line corpora (one_large) do not re-run hex/base64 trial decode after the first empty result.
