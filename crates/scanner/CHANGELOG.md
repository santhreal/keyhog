...
- Candidates retain their producer channel and exact canonical pattern ordinal through ML scoring and final adjudication without changing public `RawMatch` output, ordering, deduplication, or caps. Matcher section schema version 6 persists the ordinal and rejects stale or out-of-range provenance during hydration. Recompile installed execution packs after upgrading; version 5 matcher sections fail closed with a rebuild diagnostic.
