...
mod detail;
mod hardware;
/// Host parallelism configuration and helpers.
...
pub use runtime::{
    ...
    add_indexed_counter, add_input_bytes, add_input_units, add_stage_bytes, blocked,
    compile_surface_reports, counter_span, current_causal_parent, current_runtime, current_task_id,
    current_work_origin, decision_timer, enabled, instrument_future, instrument_future_with_parent,
    record_annotation, record_batch_route, record_cache_hit, record_cache_miss,
    record_compile_surface_invocation, record_compile_surface_invocation_with_phase,
    record_compile_surface_load, record_distribution, record_event, record_fs_metadata_latency_ns,
    ...
    serial_span, set_attribution, set_compile_phase, set_enabled, set_gauge, set_queue_depth,
    set_task_id, set_work_origin, span, span_with_parent, take_input_totals,
    take_metric_distributions, take_typed_metrics, total_runtime_compiles, Attribution,
    CausalParent, ContextGuard, CounterSpan, DecisionTimer, EventLossCounts, QueueLinkLossCounts,
    Runtime, SamplingPolicy, Span, MAX_ANNOTATIONS, MAX_BATCH_ROUTES, MAX_POINT_EVENTS,
