...
- bench(core): add criterion benchmarks for detector validation, suppression evaluation, Merkle index operations, finding deduplication, and guard state transitions (Row 147).
