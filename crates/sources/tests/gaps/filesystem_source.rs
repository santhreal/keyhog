...
//!       6. merkle skip
//!       7. archive (zip/apk/ipa/crx/jar) with symlink refusal
//!       8. compressed (gz/zst/lz4/sz)
//!       9. har
//!      10. windowed if `file_size > window_size`
//!      11. mmap/buffered text else `extract_printable_strings(_, 8)` fallback.
