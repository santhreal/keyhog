//! Zip slip variant `foo/..\..\secret.env` must not surface extracted secrets.
...
#[test]
fn zip_slip_mixed_slash_dotdot_not_extracted() {
    ...
    zip.start_file("foo/..\\..\\secret.env", opts).expect("start slip");
