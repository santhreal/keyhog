//! Zip slip variant `%2e%2e/%2e%2e/secret.env` must not surface extracted secrets.
...
#[test]
fn zip_slip_percent_encoded_dotdot_not_extracted() {
    ...
    zip.start_file("%2e%2e/%2e%2e/secret.env", opts)
        .expect("start slip");
