//! Zip slip variant `res/../../../secret.env` must not surface extracted secrets.
...
#[test]
fn zip_slip_apktool_assets_traversal_not_extracted() {
    ...
    zip.start_file("res/../../../secret.env", opts).expect("start slip");
