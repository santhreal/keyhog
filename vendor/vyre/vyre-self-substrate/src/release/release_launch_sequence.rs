...
pub fn validate_release_tag_plan_artifact(
    ...
    for (evidence, needle) in [
        ...
        ("release gate", "vyre-weir-release-gate"),
...
mod tests {
    ...
    fn launch_sequence_accepts_required_order() {
        let proof =
            validate_release_launch_sequence(&steps()).expect("valid launch sequence should pass");
    ...
    fn launch_sequence_accepts_committed_release_tag_plan() {
        ...
        .expect("committed release tag plan should contain required launch gates");
    ...
    fn launch_sequence_rejects_tag_plan_without_release_gate() {
        let err = validate_release_tag_plan_artifact(
            r#"{"vyre_rc_tag":"vyre-v0.4.1-rc.1","rc_tag":"dataflow-v0.0.1-rc.1","combined_release_train_rc_tag":"x","vyre_tag":"vyre-v0.4.1","tag":"dataflow-v0.0.1","combined_release_train_tag":"x","tag_creation_order":[],"required_gate_before_tag":"release-completion-audit && apply-branch-protection.sh","version_matrix_blocker_count":0,"blockers":[]}"#,
        )
    ...
    fn launch_receipts_accept_executed_final_launch_artifact() {
            ...
            r#"{
              ...
              "launch_receipts": {
                "cargo_publish_receipts": [
                  ...
                  {"crate": "dataflow", "command": "cargo publish -p dataflow", "status": "executed"}
                ],
        ...
        .expect("executed launch receipts should pass");
    ...
    fn launch_receipts_reject_planned_launch_without_execution() {
        let err = validate_release_launch_receipts(
            r#"{
              "schema_version": 1,
              "plan_path": "release/plans/paradigm-shift-100-concrete.md",
              "final_launch_order": ["cargo publish -p vyre", "cargo publish -p dataflow", "git push origin release", "git push --tags"],
              "blockers": []
            }"#,
        )
