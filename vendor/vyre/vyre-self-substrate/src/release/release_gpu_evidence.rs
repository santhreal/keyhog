...
mod tests {
    ...
    fn gpu_evidence_accepts_nvidia_smi_and_cargo_full_commands() {
        validate_release_gpu_evidence(evidence()).expect("valid GPU evidence should pass");
    }
    ...
    fn gpu_evidence_accepts_committed_cuda_megakernel_artifact() {
        ...
        .expect("committed CUDA megakernel release artifact should pass");
    ...
    fn gpu_evidence_accepts_committed_full_cuda_suite_artifacts() {
        ...
        .expect("committed backend matrix and CUDA suite should pass");
