...
pub fn validate_optimization_release_evidence(
    ...
    for (evidence, needle) in [
        ...
        (
            "Dataflow consumer DSE family",
            "\"family\": \"dataflow-dse\"",
        ),
        (
            "Dataflow consumer loop fusion family",
            "\"family\": \"dataflow-loop-fusion\"",
        ),
        (
            "Dataflow consumer loop fission family",
            "\"family\": \"dataflow-loop-fission\"",
        ),
        (
            "Dataflow consumer LICM family",
    ...
    for (evidence, needle) in [
        ...
        (
            "Dataflow consumer dataflow corpus coverage",
            "\"dataflow_cases\": 1024",
        ),
        (
            "Dataflow consumer dataflow optimized coverage",
    ...
    for (evidence, needle) in [
        ...
        (
            "Dataflow consumer alias analysis source",
            "\"id\": \"dataflow-alias\"",
        ),
        (
            "Dataflow reaching-def analysis source",
            "\"id\": \"dataflow-reaching-def\"",
        ),
        (
...
mod tests {
    ...
    fn optimization_release_evidence_accepts_committed_cuda_artifacts() {
        ...
        .expect("committed CUDA optimization release evidence should pass");
