...
pub fn validate_public_api_docs_artifacts(
    ...
    for (evidence, needle) in [
        ...
        ("Dataflow consumer version token", "\"0.0.1\""),
    ...
    for (evidence, needle) in [
        ...
        ("Dataflow consumer API surface contract", "0.0.1"),
        (
...
mod tests {
    ...
    fn public_api_doctests_accept_compiling_public_examples() {
        ...
        .expect("compiling public API examples should pass");
    ...
    fn public_api_doctests_accept_committed_readme_and_docs_artifacts() {
        ...
        .expect("committed public docs artifacts should pass");
