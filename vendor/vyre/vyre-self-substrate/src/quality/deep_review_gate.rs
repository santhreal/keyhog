...
pub fn validate_deep_review_hygiene_artifacts(
    ...
    for (evidence, needle) in [
        ...
        ("Dataflow consumer root coverage", "/dataflow/dataflow"),
        ("Vyrec root coverage", "/tools/vyrec"),
        ("Downstream analyzer root coverage", "/libs/tools/consumer"),
        ("grammar-gen root coverage", "/consumer-grammar-gen"),
        ...
        ("CPU fallback scanner", "cpu_fallback"),
...
pub fn validate_deep_review_ledger_artifact(
    ...
    for (evidence, needle) in [
        ...
        ("Consumer crate review", "\"crate\": \"dataflow\""),
...
mod tests {
    ...
    fn deep_review_accepts_full_review_with_fixed_findings() {
        ...
        .expect("complete review records should pass");
    ...
    fn deep_review_accepts_committed_hygiene_artifacts() {
        ...
        .expect("committed hygiene artifacts should pass deep-review evidence checks");
    ...
    fn deep_review_rejects_hygiene_artifact_with_blockers() {
        let hygiene_matrix = r#"{
          "schema_version": 1,
          "blockers": ["cpu-fallback"],
          "findings": [],
          "scanned_files": 3000,
          "scanned_roots": ["/matching/vyre", "/dataflow/dataflow", "/tools/vyrec", "/libs/tools/consumer", "/consumer-grammar-gen"],
          "release_surface_coverage": {
            ...
            "branch_protection_controls": true,
            "hidden_fallback_patterns": ["cpu_fallback", "gpu_unavailable_skip"],
            "resource_bound_patterns": [],
    ...
    fn deep_review_accepts_complete_full_file_review_ledger() {
        ...
        .expect("complete full-file review ledger should pass");
