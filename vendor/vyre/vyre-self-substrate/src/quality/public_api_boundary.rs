...
pub fn validate_public_api_source_boundaries(
    ...
    for surface in surfaces {
        ...
        if surface.crate_name == "dataflow" {
            ...
            require_source_contains(
                surface,
                "Dataflow consumer public scratch contract",
...
mod tests {
    ...
    fn public_api_boundary_accepts_contract_level_exports() {
        ...
        .expect("contract-level exports should pass");
    ...
    fn public_api_boundary_accepts_committed_source_surfaces() {
        let proof = validate_public_api_source_boundaries(
            ...
            include_str!("../../../release/evidence/weir/weir-readme-contracts.json"),
            include_str!("../../../release/evidence/docs/docs-matrix.json"),
        )
        .expect("committed public source surfaces should keep internals behind boundaries");
    ...
    fn public_api_boundary_rejects_cuda_pipeline_module_export() {
        ...
        let surfaces = [
            ...
            source_surface(
                "dataflow",
                include_str!("../../../../../../dataflow/weir/src/lib.rs"),
                false,
            ),
        ];
    ...
    fn public_api_boundary_rejects_incomplete_docs_evidence() {
        let docs_matrix = include_str!("../../../release/evidence/docs/docs-matrix.json").replace(
            "\"blockers\": []",
    ...
    fn source_surfaces() -> [PublicApiSourceSurface<'static>; 4] {
        [
            source_surface(
                "vyre-driver-cuda",
