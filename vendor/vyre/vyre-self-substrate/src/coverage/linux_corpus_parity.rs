...
mod tests {
    ...
    fn linux_corpus_parity_accepts_provenanced_clang_slices() {
        ...
        .expect("valid Linux corpus slices should pass");
    ...
    fn linux_corpus_parity_accepts_committed_linux_subsystem_artifacts() {
        let proof = validate_committed_linux_corpus_artifacts(
            include_str!("../../../release/evidence/parser/linux-subsystem-corpus-manifest.json"),
        ...
        .expect("committed Linux subsystem parser artifacts should pass");
    ...
    fn linux_corpus_parity_accepts_committed_proof_doc_alignment() {
        ...
        .expect("C parser proof doc should match committed Linux lib corpus evidence");
