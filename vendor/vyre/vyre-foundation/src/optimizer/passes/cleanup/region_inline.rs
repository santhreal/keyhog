...
mod tests {
    ...
    fn region_inline_analyze_skips_without_regions() {
        ...
        assert_eq!(crate::optimizer::ProgramPass::analyze(&RegionInlinePass, &p), PassAnalysis::SKIP);
    }
    ...
    fn region_inline_analyze_runs_with_regions() {
        ...
        assert_eq!(crate::optimizer::ProgramPass::analyze(&RegionInlinePass, &p), PassAnalysis::RUN);
    }
