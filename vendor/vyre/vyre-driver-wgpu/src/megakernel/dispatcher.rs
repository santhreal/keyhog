...
impl BatchDispatcher {
    ...
    pub fn dispatch(
        ...
        self.pipeline.dispatch_persistent_borrowed(
            &inputs,
            &outputs,
            None,
        ...
        let queue_state_words = u32_words_from_readback(&self.queue_state_bytes, "queue-state")?;
        ...
        let hit_words = u32_words_from_readback(&self.hit_bytes, "hit-ring")?;
