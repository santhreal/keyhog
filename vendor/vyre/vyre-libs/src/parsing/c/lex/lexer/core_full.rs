...
use super::helpers::{
    byte_eq, byte_load, is_digit, is_ident_continue, is_ident_start, set_token,
};
...
pub fn c11_lexer(
            ...
            Node::loop_for(
                ...
                vec![Node::if_then(
                    ...
                    vec![
                        ...
                        Node::let_bind("scan_next", Expr::u32(0)),
                        Node::if_then(
                            byte_eq(Expr::var("scan_byte"), b'*'),
                            vec![Node::assign(
                                "scan_next",
    ...
    classify_at_pos.extend(super::core_full_literals::full_prefixed_literal_pushes());
            ...
            Node::loop_for(
                ...
                vec![Node::if_then(
                    ...
                    vec![
                        ...
                        Node::if_then(
                            Expr::and(
                                Expr::var("scan_is_exponent_marker"),
                                Expr::lt(
    ...
    classify_at_pos.extend(super::core_full_literals::full_literal_pushes(haystack, haystack_len));
