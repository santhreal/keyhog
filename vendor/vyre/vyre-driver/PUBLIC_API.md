...
pub fn vyre_driver::self_substrate::dataflow_fixpoint::semiring_gemm_cpu(a: &[u32], b: &[u32], m: u32, n: u32, k: u32, semiring: vyre_driver::self_substrate::dataflow_fixpoint::Semiring) -> alloc::vec::Vec<u32>
...
pub fn vyre_driver::self_substrate::persistent_homology_loop_signature::h1_birth_scales(dist_matrix: &[f64], epsilons: &[f64], n: u32) -> alloc::vec::Vec<(f64, u32)>
pub fn vyre_driver::self_substrate::persistent_homology_loop_signature::loop_filtration_betti(dist_matrix: &[f64], epsilons: &[f64], n: u32) -> alloc::vec::Vec<(u32, u32)>
pub fn vyre_driver::self_substrate::persistent_homology_loop_signature::loop_filtration_edge_counts(dist_matrix: &[f64], epsilons: &[f64], n: u32) -> alloc::vec::Vec<u32>
pub fn vyre_driver::self_substrate::persistent_homology_loop_signature::region_loop_edges(dist_matrix: &[f64], epsilon: f64, n: u32) -> alloc::vec::Vec<(u32, u32)>
pub fn vyre_driver::self_substrate::persistent_homology_loop_signature::region_loop_skeleton(dist_matrix: &[f64], epsilon: f64, n: u32) -> alloc::vec::Vec<u32>
...
pub fn vyre_driver::self_substrate::scallop_provenance::cpu_provenance_closure(state: &[u32], join_rules: &[u32], n: u32, max_iterations: u32) -> alloc::vec::Vec<u32>
...
pub fn vyre_driver::self_substrate::sinkhorn_dispatch_clustering::sinkhorn_clustering_cpu(region_features: &[f32], cluster_centroids: &[f32], region_weights: &[f32], cluster_capacities: &[f32], m: u32, n: u32, d: u32, iters: u32, eps: f32) -> alloc::vec::Vec<u32>
...
pub fn vyre_driver::self_substrate::union_find_emit::emit_union_find_block() -> alloc::string::String
...
pub fn vyre_driver::self_substrate::vsa_fingerprint::vsa_fingerprint_cpu(program: &vyre_foundation::ir_inner::model::program::core::Program) -> alloc::vec::Vec<u32>
