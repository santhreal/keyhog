//! Weir-provided alias and points-to facts for lowering legality.
//!
//! This module is the substrate-neutral boundary between Weir dataflow
...
impl AliasFactSet {
    ...
    /// Return true when Weir proved the two descriptor addresses cannot alias.
    #[must_use]
