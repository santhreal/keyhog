...
Finding digests cover the sorted detector ID, source path, line, byte span, and credential SHA-256 for every downstream finding. Credential values are never written.
