...
| Kingfisher | `default-nocache-nodaemon-low-no-validate` | creddata | 7.60s | 127.8 MB/s | 627 MB |
| TruffleHog | `default-nocache-nodaemon-no-verify` | creddata | 19.98s | 48.6 MB/s | 644 MB |
| TruffleHog | `default-nocache-nodaemon-no-verify` | creddata | 32.12s | 30.2 MB/s | 711 MB |
| KeyHog | `simd-nocache-nodaemon-full` | creddata | 1.1m | 14.9 MB/s | 2506 MB |
| KeyHog | `simd-nocache-nodaemon-full` | creddata | 1.2m | 13.7 MB/s | 2497 MB |
| KeyHog | `simd-nocache-nodaemon-full` | creddata | 1.2m | 13.4 MB/s | 2512 MB |
| KeyHog | `simd-nocache-nodaemon-full` | creddata | 1.3m | 12.3 MB/s | 2508 MB |
| KeyHog | `simd-nocache-nodaemon-full` | creddata | 1.4m | 11.2 MB/s | 2480 MB |
| KeyHog | `simd-nocache-nodaemon-full` | creddata | 1.5m | 10.9 MB/s | 2517 MB |
