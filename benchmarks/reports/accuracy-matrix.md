...
KeyHog `KeyHog v0.5.70` evaluated on the synthetic **mirror** corpus on **AMD Ryzen 9 9950X 16-Core Processor** with the explicit Hyperscan/SIMD default route. The answer-key manifest was excluded from the scan tree.
