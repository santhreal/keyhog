...
def render(evidence: object) -> str:
    ...
    trial_label = "trial" if root["trial_count"] == 1 else "trials"
    warmup_label = "warm-up" if root["warmups"] == 1 else "warm-ups"
    lines = [
        BEGIN,
        ...
        (
            ...
            f"{root['trial_count']} measured {trial_label} after "
            f"{root['warmups']} {warmup_label} "
