...
Law 10 was written in CLAUDE.md the whole time 193 silent fallbacks accumulated.
...
regenerate it, so the baseline can only SHRINK. The 193 audited violations live in
