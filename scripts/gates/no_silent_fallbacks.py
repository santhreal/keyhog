...
Law 10 was written in CLAUDE.md the whole time 200 silent fallbacks accumulated.
...
regenerate it, so the baseline can only SHRINK. The 200 audited violations live in
