...
|---|---:|---:|---:|---:|
| Hyperscan/SIMD | 1.31 s | 1.77 MB/s | 1031 MiB | 0.9447 |
| Pure-Rust CPU | 2.27 s | 1.02 MB/s | 1070 MiB | 0.9447 |
| CUDA | 11.69 s | 0.20 MB/s | 1756 MiB | 0.9447 |
| WGPU | 12.70 s | 0.18 MB/s | 1660 MiB | 0.9447 |
| Automatic | 2.76 s | 0.84 MB/s | 1170 MiB | 0.9447 |
...
|---|---:|---:|---:|---:|---:|
| Fast | 1.18 s | 0.9733 | 0.9113 | 0.9413 | 2,816 |
| Default | 1.31 s | 0.9708 | 0.9200 | 0.9447 | 2,868 |
| Deep | 1.19 s | 0.9708 | 0.9207 | 0.9451 | 2,875 |
| Precision | 1.15 s | 0.9690 | 0.8033 | 0.8784 | 2,488 |
...
|---|---:|---:|---:|
| Cache off | 1.31 s | 1.77 MB/s | 1031 MiB |
| Warm incremental cache | 1.12 s | 2.06 MB/s | 1057 MiB |
<!-- BENCH:config:end -->
...
Host: `AMD Ryzen 9 9950X 16-Core Processor`, 32 effective logical cores, 94,140 MiB RAM, `Linux 6.17.0-19-generic`. Evidence: `developer-dirty`, binary `0a6d9b8fb071`.

#### Scan worker scaling

| Workers | Reader threads | Median wall | p95 wall | Throughput | Speedup | Efficiency | Median peak RSS |
|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | auto | 18,632.8 ms | 18,699.8 ms | 3.4 MiB/s | 1.00x | 100.0% | 662.3 MiB |
| 2 | auto | 9,533.8 ms | 9,777.2 ms | 6.7 MiB/s | 1.95x | 97.7% | 670.7 MiB |
| 4 | auto | 5,612.4 ms | 5,786.0 ms | 11.4 MiB/s | 3.32x | 83.0% | 684.5 MiB |
| 8 | auto | 2,761.6 ms | 2,777.9 ms | 23.2 MiB/s | 6.75x | 84.3% | 711.9 MiB |
| 16 | auto | 1,791.1 ms | 1,800.5 ms | 35.7 MiB/s | 10.40x | 65.0% | 764.2 MiB |
| 32 | auto | 1,442.4 ms | 1,520.4 ms | 44.4 MiB/s | 12.92x | 40.4% | 817.4 MiB |
...
|---:|---:|---:|---:|---:|---:|---:|
| 32 | 1 | 1,614.6 ms | 1,720.7 ms | 39.6 MiB/s | 1.00x | 803.6 MiB |
| 32 | 2 | 1,626.6 ms | 1,648.3 ms | 39.3 MiB/s | 0.99x | 810.7 MiB |
| 32 | 4 | 1,628.1 ms | 1,665.7 ms | 39.3 MiB/s | 0.99x | 817.4 MiB |
| 32 | 8 | 1,590.9 ms | 1,629.4 ms | 40.2 MiB/s | 1.01x | 821.8 MiB |
| 32 | 16 | 1,632.0 ms | 1,634.5 ms | 39.2 MiB/s | 0.99x | 814.3 MiB |
| 32 | 32 | 1,557.2 ms | 1,601.3 ms | 41.1 MiB/s | 1.04x | 820.1 MiB |

#### Corpus-size scaling

| Corpus | Files | Exact bytes | Median wall | p95 wall | Throughput | Median peak RSS |
|---|---:|---:|---:|---:|---:|---:|
| small | 256 | 8 MiB | 615.5 ms | 635.2 ms | 13.0 MiB/s | 743.4 MiB |
| medium | 1,024 | 64 MiB | 1,553.7 ms | 1,566.8 ms | 41.2 MiB/s | 816.3 MiB |
| large | 2,048 | 256 MiB | 4,721.7 ms | 4,851.6 ms | 54.2 MiB/s | 933.8 MiB |

#### Storage scaling

| Storage class | Filesystem | Device ID | Median wall | p95 wall | Throughput | Relative to first storage | Median peak RSS |
|---|---|---:|---:|---:|---:|---:|---:|
| workspace | `ext4` | `66305` | 1,558.8 ms | 1,619.2 ms | 41.1 MiB/s | 1.00x | 820.2 MiB |
| local-temp | `ext4` | `66308` | 1,589.2 ms | 1,593.9 ms | 40.3 MiB/s | 0.98x | 820.3 MiB |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 32 | 32 | 256 | 8 MiB | 622.6 ms | 12.8 MiB/s | 1.00x | 756.0 MiB |
| 2 | 16 | 32 | 512 | 16 MiB | 877.1 ms | 18.2 MiB/s | 1.42x | 1,436.4 MiB |
| 4 | 8 | 32 | 1,024 | 32 MiB | 1,379.8 ms | 23.2 MiB/s | 1.80x | 2,739.5 MiB |
...
|---|---|---|---|---|---|
| Betterleaks | `default-nocache-nodaemon-no-validate` | mirror | 0.73s | 3.2 MB/s | 194 MB |
| KeyHog | `simd-nocache-nodaemon-full` | mirror | 1.22s | 1.9 MB/s | 1035 MB |
| Kingfisher | `default-nocache-nodaemon-low-no-validate` | mirror | 4.22s | 0.5 MB/s | 436 MB |
<!-- BENCH:perf:end -->
...
Selected run: scanner **KeyHog** `KeyHog v0.5.49<br>Commit: 7734849bf6eff98f42d6985b64a6f3b44b4d3c6b<br>Detector Set: 923 (923-8785f8837d2cd505)<br>Build Target: x86_64-linux<br>ML Model Version: moe-v1-246a05b92bec9aa3<br>ML Model Card: recorded 2026-07-15; features 55; synthetic F1 0.971 / P 0.945 / R 0.999; real F1 0.832 / P 0.753 / R 0.931 / recall@0.40 0.938; zero-recall detectors 2/32; six-scanner differential unavailable`; corpus **mirror** (15,000 fixtures, 2,430,321 bytes); generated `2026-07-31T06:47:34Z`; artifact `mirror-keyhog-simd-nocache-nodaemon-full.json`.
...
| Executable SHA-256 | `0a6d9b8fb0710bcc3600be004e32366057034c03159e34158e1aa835c7689a84` |
