<p align="center">
  <img src="docs/assets/keyhog-banner.svg" alt="keyhog - secret scanner - 901 detectors - gpu" width="560" />
</p>
...
running systems for leaked credentials. **901 service-specific detectors**,
...
no libstdc++ link. Same 901 detectors, same ML/entropy/decode/multiline
...
keyhog compiles its 901 detectors into a single Hyperscan NFA database,
...
```
keyhog v0.5.37 | 16 cores | SIMD: AVX-512 | Hyperscan | 901 detectors
```
...
audit failure, `4` `backend --self-test` failed, `10` live
...
901 service-specific detectors with checksum / companion validation:
...
loads all 901 with severity + service + keyword filter.
...
detectors/    901 TOML files (data, not code)
