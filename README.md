...
|---|---:|---:|---:|---:|
| Hyperscan/SIMD | 1.12 s | 2.06 MB/s | 1028 MiB | 0.9447 |
| Pure-Rust CPU | 2.23 s | 1.04 MB/s | 1070 MiB | 0.9447 |
| CUDA | 12.22 s | 0.19 MB/s | 1748 MiB | 0.9447 |
| WGPU | 11.79 s | 0.20 MB/s | 1653 MiB | 0.9447 |
| Automatic | 2.43 s | 0.95 MB/s | 1160 MiB | 0.9447 |
...
|---|---:|---:|---:|---:|---:|
| Fast | 899 ms | 0.9733 | 0.9113 | 0.9413 | 2,816 |
| Default | 1.12 s | 0.9708 | 0.9200 | 0.9447 | 2,868 |
| Deep | 1.04 s | 0.9708 | 0.9207 | 0.9451 | 2,875 |
| Precision | 1.02 s | 0.9690 | 0.8033 | 0.8784 | 2,488 |
...
|---|---:|---:|---:|
| Cache off | 1.12 s | 2.06 MB/s | 1028 MiB |
| Warm incremental cache | 1.15 s | 2.02 MB/s | 1053 MiB |
<!-- BENCH:config:end -->
...
Host: `AMD Ryzen 9 9950X 16-Core Processor`, 32 effective logical cores, 94,140 MiB RAM, `Linux 6.17.0-19-generic`. Evidence: `developer-dirty`, binary `5edace3a9fc1`.

#### Scan worker scaling

| Workers | Reader threads | Median wall | p95 wall | Throughput | Speedup | Efficiency | Median peak RSS |
|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | auto | 18,540.3 ms | 18,547.0 ms | 3.5 MiB/s | 1.00x | 100.0% | 662.3 MiB |
| 2 | auto | 9,452.0 ms | 9,493.5 ms | 6.8 MiB/s | 1.96x | 98.1% | 670.9 MiB |
| 4 | auto | 4,984.5 ms | 4,992.7 ms | 12.8 MiB/s | 3.72x | 93.0% | 685.9 MiB |
| 8 | auto | 2,712.3 ms | 2,759.7 ms | 23.6 MiB/s | 6.84x | 85.4% | 708.9 MiB |
| 16 | auto | 1,683.1 ms | 1,696.0 ms | 38.0 MiB/s | 11.02x | 68.8% | 765.5 MiB |
| 32 | auto | 1,399.4 ms | 1,445.2 ms | 45.7 MiB/s | 13.25x | 41.4% | 819.1 MiB |
...
|---:|---:|---:|---:|---:|---:|---:|
| 32 | 1 | 1,515.8 ms | 1,532.7 ms | 42.2 MiB/s | 1.00x | 804.6 MiB |
| 32 | 2 | 1,485.9 ms | 1,547.4 ms | 43.1 MiB/s | 1.02x | 813.5 MiB |
| 32 | 4 | 1,480.8 ms | 1,547.8 ms | 43.2 MiB/s | 1.02x | 818.5 MiB |
| 32 | 8 | 1,460.2 ms | 1,496.0 ms | 43.8 MiB/s | 1.04x | 819.3 MiB |
| 32 | 16 | 1,490.7 ms | 1,519.4 ms | 42.9 MiB/s | 1.02x | 817.9 MiB |
| 32 | 32 | 1,545.3 ms | 1,601.1 ms | 41.4 MiB/s | 0.98x | 825.2 MiB |

#### Corpus-size scaling

| Corpus | Files | Exact bytes | Median wall | p95 wall | Throughput | Median peak RSS |
|---|---:|---:|---:|---:|---:|---:|
| small | 256 | 8 MiB | 627.1 ms | 680.6 ms | 12.8 MiB/s | 744.1 MiB |
| medium | 1,024 | 64 MiB | 1,483.3 ms | 1,527.6 ms | 43.1 MiB/s | 822.9 MiB |
| large | 2,048 | 256 MiB | 4,595.0 ms | 4,650.6 ms | 55.7 MiB/s | 938.2 MiB |

#### Storage scaling

| Storage class | Filesystem | Device ID | Median wall | p95 wall | Throughput | Relative to first storage | Median peak RSS |
|---|---|---:|---:|---:|---:|---:|---:|
| workspace | `ext4` | `66305` | 1,513.8 ms | 1,524.7 ms | 42.3 MiB/s | 1.00x | 811.2 MiB |
| local-temp | `ext4` | `66308` | 1,477.5 ms | 1,483.4 ms | 43.3 MiB/s | 1.02x | 818.6 MiB |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 32 | 32 | 256 | 8 MiB | 591.4 ms | 13.5 MiB/s | 1.00x | 753.2 MiB |
| 2 | 16 | 32 | 512 | 16 MiB | 752.4 ms | 21.3 MiB/s | 1.57x | 1,428.8 MiB |
| 4 | 8 | 32 | 1,024 | 32 MiB | 1,140.4 ms | 28.1 MiB/s | 2.07x | 2,727.1 MiB |
...
|---|---|---|---|---|---|
| Betterleaks | `default-nocache-nodaemon-no-validate` | mirror | 0.69s | 3.4 MB/s | 198 MB |
| KeyHog | `simd-nocache-nodaemon-full` | mirror | 1.07s | 2.2 MB/s | 1037 MB |
| Kingfisher | `default-nocache-nodaemon-low-no-validate` | mirror | 4.48s | 0.5 MB/s | 430 MB |
<!-- BENCH:perf:end -->
...
Selected run: scanner **KeyHog** `KeyHog v0.5.49<br>Commit: 4dd24a20bef92f1369b52933c90d56a0ec27e463<br>Detector Set: 923 (923-8785f8837d2cd505)<br>Build Target: x86_64-linux<br>ML Model Version: moe-v1-246a05b92bec9aa3<br>ML Model Card: recorded 2026-07-15; features 55; synthetic F1 0.971 / P 0.945 / R 0.999; real F1 0.832 / P 0.753 / R 0.931 / recall@0.40 0.938; zero-recall detectors 2/32; six-scanner differential unavailable`; corpus **mirror** (15,000 fixtures, 2,430,321 bytes); generated `2026-07-31T09:40:34Z`; artifact `mirror-keyhog-simd-nocache-nodaemon-full.json`.
...
| Executable SHA-256 | `5edace3a9fc15f2aee85095e9b2b5b8a558fe8550ae0c9c6aff5e7498cab0f26` |
