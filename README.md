...
|---|---:|---:|---:|---:|
| Hyperscan/SIMD | 1.07 s | 2.17 MB/s | 1056 MiB | 0.9447 |
| Pure-Rust CPU | 2.33 s | 0.99 MB/s | 1079 MiB | 0.9447 |
| CUDA | 11.55 s | 0.20 MB/s | 1749 MiB | 0.9447 |
| WGPU | 11.75 s | 0.20 MB/s | 1677 MiB | 0.9447 |
| Automatic | 2.60 s | 0.89 MB/s | 1179 MiB | 0.9447 |
...
|---|---:|---:|---:|---:|---:|
| Fast | 948 ms | 0.9733 | 0.9113 | 0.9413 | 2,816 |
| Default | 1.07 s | 0.9708 | 0.9200 | 0.9447 | 2,868 |
| Deep | 1.05 s | 0.9708 | 0.9207 | 0.9451 | 2,875 |
| Precision | 1.07 s | 0.9690 | 0.8033 | 0.8784 | 2,488 |
...
|---|---:|---:|---:|
| Cache off | 1.07 s | 2.17 MB/s | 1056 MiB |
| Warm incremental cache | 1.05 s | 2.21 MB/s | 1068 MiB |
<!-- BENCH:config:end -->
...
Host: `AMD Ryzen 9 9950X 16-Core Processor`, 32 effective logical cores, 94,140 MiB RAM, `Linux 6.17.0-19-generic`. Evidence: `developer-dirty`, binary `ae439625204f`.

#### Scan worker scaling

| Workers | Reader threads | Median wall | p95 wall | Throughput | Speedup | Efficiency | Median peak RSS |
|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | auto | 18,353.7 ms | 19,583.6 ms | 3.5 MiB/s | 1.00x | 100.0% | 663.0 MiB |
| 2 | auto | 9,384.4 ms | 9,392.2 ms | 6.8 MiB/s | 1.96x | 97.8% | 670.6 MiB |
| 4 | auto | 4,950.0 ms | 4,980.8 ms | 12.9 MiB/s | 3.71x | 92.7% | 682.6 MiB |
| 8 | auto | 2,747.8 ms | 2,750.5 ms | 23.3 MiB/s | 6.68x | 83.5% | 708.3 MiB |
| 16 | auto | 1,833.0 ms | 1,842.3 ms | 34.9 MiB/s | 10.01x | 62.6% | 765.2 MiB |
| 32 | auto | 1,494.4 ms | 1,506.6 ms | 42.8 MiB/s | 12.28x | 38.4% | 814.8 MiB |
...
|---:|---:|---:|---:|---:|---:|---:|
| 32 | 1 | 1,587.1 ms | 1,591.4 ms | 40.3 MiB/s | 1.00x | 805.7 MiB |
| 32 | 2 | 1,552.1 ms | 1,576.8 ms | 41.2 MiB/s | 1.02x | 818.9 MiB |
| 32 | 4 | 1,538.8 ms | 1,539.0 ms | 41.6 MiB/s | 1.03x | 826.4 MiB |
| 32 | 8 | 1,551.2 ms | 1,585.9 ms | 41.3 MiB/s | 1.02x | 818.7 MiB |
| 32 | 16 | 1,556.4 ms | 1,562.3 ms | 41.1 MiB/s | 1.02x | 815.4 MiB |
| 32 | 32 | 1,554.7 ms | 1,583.6 ms | 41.2 MiB/s | 1.02x | 821.2 MiB |

#### Corpus-size scaling

| Corpus | Files | Exact bytes | Median wall | p95 wall | Throughput | Median peak RSS |
|---|---:|---:|---:|---:|---:|---:|
| small | 256 | 8 MiB | 607.0 ms | 612.2 ms | 13.2 MiB/s | 758.5 MiB |
| medium | 1,024 | 64 MiB | 1,554.8 ms | 1,556.6 ms | 41.2 MiB/s | 822.3 MiB |
| large | 2,048 | 256 MiB | 4,885.4 ms | 4,902.3 ms | 52.4 MiB/s | 937.4 MiB |

#### Storage scaling

| Storage class | Filesystem | Device ID | Median wall | p95 wall | Throughput | Relative to first storage | Median peak RSS |
|---|---|---:|---:|---:|---:|---:|---:|
| workspace | `ext4` | `66305` | 1,570.7 ms | 1,638.6 ms | 40.7 MiB/s | 1.00x | 811.5 MiB |
| local-temp | `ext4` | `66308` | 1,579.3 ms | 1,588.4 ms | 40.5 MiB/s | 0.99x | 814.2 MiB |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 32 | 32 | 256 | 8 MiB | 591.7 ms | 13.5 MiB/s | 1.00x | 750.8 MiB |
| 2 | 16 | 32 | 512 | 16 MiB | 828.0 ms | 19.3 MiB/s | 1.43x | 1,433.4 MiB |
| 4 | 8 | 32 | 1,024 | 32 MiB | 1,235.7 ms | 25.9 MiB/s | 1.92x | 2,738.3 MiB |
...
|---|---|---|---|---|---|
| Betterleaks | `default-nocache-nodaemon-no-validate` | mirror | 0.72s | 3.2 MB/s | 184 MB |
| KeyHog | `simd-nocache-nodaemon-full` | mirror | 1.09s | 2.1 MB/s | 1039 MB |
| Kingfisher | `default-nocache-nodaemon-low-no-validate` | mirror | 4.63s | 0.5 MB/s | 427 MB |
<!-- BENCH:perf:end -->
...
Selected run: scanner **KeyHog** `KeyHog v0.5.49<br>Commit: e1bc248444389126f5f43e33a7bb983b72100ec8<br>Detector Set: 923 (923-8785f8837d2cd505)<br>Build Target: x86_64-linux<br>ML Model Version: moe-v1-246a05b92bec9aa3<br>ML Model Card: recorded 2026-07-15; features 55; synthetic F1 0.971 / P 0.945 / R 0.999; real F1 0.832 / P 0.753 / R 0.931 / recall@0.40 0.938; zero-recall detectors 2/32; six-scanner differential unavailable`; corpus **mirror** (15,000 fixtures, 2,430,321 bytes); generated `2026-07-31T05:10:51Z`; artifact `mirror-keyhog-simd-nocache-nodaemon-full.json`.
...
| Executable SHA-256 | `ae439625204f0508b5ae6d98055d9a171f1a6066ac5e8ee3517688d513a6f9d3` |
