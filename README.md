<p align="center">
  <img src="docs/assets/keyhog-banner.svg" alt="keyhog - secret scanner - 905 detectors - gpu" width="560" />
</p>
...
repository collections, S3/GCS/Azure Blob buckets, and running systems for leaked credentials. **905 service-specific detectors**,
...
no libstdc++ link. Same 905 detectors, same ML/entropy/decode/multiline
...
keyhog compiles its 905 detectors into a shared trigger/extraction plan,
...
⚡ 16 cores | SIMD: AVX-512 | Hyperscan | 905 detectors (6054 patterns) | backend=simd-regex
```
...
905 service-specific detectors with checksum / companion validation:
...
loads all 905 with severity + service + keyword filter.
...
detectors/    905 TOML files (data, not code)
