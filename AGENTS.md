...
- Gemini polling discipline: result collection is also async work. Poll with `timeout_seconds >= 3600` and `wait: false`; do not sit on `gemini_result` waiting for completion.
